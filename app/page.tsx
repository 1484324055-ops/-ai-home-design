    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-[var(--background)]">
        ...
        <main className="mx-auto max-w-[1600px] px-3 py-3 pb-24 sm:px-6 sm:py-5 sm:pb-28 lg:px-8 lg:pb-6">
          <div className="lg:grid lg:grid-cols-[320px_minmax(0,1fr)] lg:gap-5 xl:grid-cols-[340px_minmax(0,1fr)]">
            ...
            <section className="min-w-0 space-y-4 sm:space-y-6">
              <div className="rounded-[20px] border border-[var(--border)] bg-[var(--card-bg)] p-3 shadow-[0_12px_40px_rgba(15,23,42,0.05)] sm:rounded-[24px] sm:p-5">
